...
function heroSubmit() {
    ...
    if (!email || !email.includes('@')) { document.getElementById('heroEmail').style.borderColor = '#ff4444'; setTimeout(() => document.getElementById('heroEmail').style.borderColor = '', 1500); return; }
...
function waitlistSubmit() {
    ...
    if (!email || !email.includes('@')) { document.getElementById('wEmail').style.borderColor = '#ff4444'; setTimeout(() => document.getElementById('wEmail').style.borderColor = '', 1500); return; }
